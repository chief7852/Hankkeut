...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse topMenu" id="myNavbar">
				<ul class="menu01">
					...
					<li><span>홍보영상</span>
						<ul class="dept01">
							<li class="nop"><a href="./guide/guide_main.html" target="ifr">홍보영상</a></li>
						</ul></li>
					<li><span>커뮤니티</span>
						<ul class="dept01">
				...
				<ul class="menu02">
					<li>
						...
						%> --%>
						<img src="./img/gameBtn.PNG" onClick="window.open('<%=request.getContextPath()%>/login/isLogin.ddit', '','width= 1700, height= 900px, resizable=no')" style="width: 200px; hegiht: 100px;">
					</li>
				</ul>
			</div>
		</div>
	...
	<section>
	  	<article>
	  		<iframe title="" name="ifr" src="./home_main/main.html" width="100%" height="100%"></iframe>
	  	</article>
	</section>
