...
$(function(){
	...
	playbackmusic = new Audio('../multichat/backMusic.mp3');
   	...
   	$('#effectsoundOFF').on('click',function(){
   		...
   		$('#autoready1').on('click',function(){
   			updateready1(userInfo);
   		})
		
   		$('#autoready2').on('click',function(){
   			updateready0(userInfo);
   		})
...
<body id="mainBody">
<audio src="../multichat/backMusic.mp3" autoplay id="mainaudio" loop ></audio>
