  ...
  <div  class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <ul class="nav nav-pills nav-stacked">
        <li class="active"><a href="#section1">캐릭터 닉네임</a></li>
      </ul><br>
    ...
    <div class="col-sm-9">
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="well">
            <h4>아이템2</h4>
           <p id="show2" class="showclass">이미지출력자리</p>
           <button type="button" class="btn btn-info">착용</button>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="well">
            <h4>아이템3</h4>
           <p id="show3" class="showclass">이미지출력자리</p>
           <button type="button" class="btn btn-info">착용</button>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="well">
            <h4>아이템4</h4>
          <p id="show4" class="showclass">이미지출력자리</p>
          <button type="button" class="btn btn-info">착용</button> 
          </div>
        </div>
         <div class="col-sm-3">
          <div class="well">
            <h4>아이템5</h4>
           <p id="show5" class="showclass">이미지출력자리</p>
           <button type="button" class="btn btn-info">착용</button>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="well">
            <h4>아이템6</h4>
            <p id="show6" class="showclass">이미지출력자리</p>
            <button type="button" class="btn btn-info">착용</button>
          </div>
        </div>
         <div class="col-sm-3">
